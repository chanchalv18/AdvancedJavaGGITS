...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements google.chanchal.WebService.CalculatorService {
    ...
    private java.lang.String calculator_address = "http://localhost:9865/OurFirstWebServices/services/calculator";
    ...
    public google.chanchal.WebService.Calculator getcalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            google.chanchal.WebService.CalculatorSoapBindingStub _stub = new google.chanchal.WebService.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (google.chanchal.WebService.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                google.chanchal.WebService.CalculatorSoapBindingStub _stub = new google.chanchal.WebService.CalculatorSoapBindingStub(new java.net.URL(calculator_address), this);
                _stub.setPortName(getcalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://WebService.chanchal.google", "calculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://WebService.chanchal.google", "calculator"));
        }
